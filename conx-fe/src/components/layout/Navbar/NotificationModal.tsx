...
export default function NotificationModal({ open, onClose }: NotificationModalProps) {
  ...
  return (
    ...
    <div
      ...
      tabIndex={-1}
      aria-label="알림"
      className="z-conx-dropdown drop-shadow-conx-drop-gray bg-conx-gray-50 absolute top-full -right-5 mt-3 flex w-[425px] flex-col overflow-hidden rounded-[12px] focus:outline-none"
    >
      {/* Header (white) */}
