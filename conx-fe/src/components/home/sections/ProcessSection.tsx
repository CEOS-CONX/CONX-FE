...
> = {
  1: {
    company: {
      ...
      description:
        '우리 크루의 성격과 Fit이 맞는 기업의 스폰서십 프로젝트를 발굴하고 실행 아이디어를 기획합니다.',
    },
    crew: {
      title: '프로젝트 탐색 및 기획',
      description:
        '예산, 목적, 타겟팅하는 MZ 세대의 특성을 설정하여 직관적으로 스폰서십 프로젝트를 오픈합니다.',
    },
  },
  2: {
    company: {
      ...
      description:
        '프로젝트에 지원한 다양한 크루들의 포트폴리오와 아이디어를 비교하고, 브랜드에 가장 적합한 크루를 선택합니다.',
    },
    crew: {
      title: '다이렉트 제안 및 매칭',
      description:
        '크루만의 강점이 담긴 기획안으로 프로젝트에 지원하고, 기업 실무진과 직접 소통하며 업무 및 예산을 조율합니다.',
    },
  },
  3: {
    company: {
      ...
      description:
        '매칭된 크루가 캠퍼스와 온라인 현장 최전선에서 트렌디하고 진정성 있는 브랜드 캠페인을 직접 전개합니다.',
    },
    crew: {
      title: '실전 B2B 프로젝트 운영',
      description:
        '확보된 기업 예산을 바탕으로, 기획했던 캠페인을 크루 주도하에 현장에서 실행하며 진짜 실무를 경험합니다.',
    },
  },
  4: {
    company: {
      ...
      description:
        '크루가 만들어낸 실질적인 반응, 도달률, 결과물을 빠르게 확인하고 데이터화된 마케팅 성과를 확보합니다.',
    },
    crew: {
      title: '포트폴리오 구축 및 크루 운영비 확보',
      description:
        '증명된 마케팅 결과물을 압도적인 레퍼런스로 아카이빙하고, 프로젝트 수행금을 획득하여 크루의 든든한 운영 자본을 마련합니다.',
    },
  },
};
